...
class PokemonItemResponse {
  ...
  factory PokemonItemResponse.fromMap(Map<String, dynamic> data) {
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [PokemonItemResponse].
  factory PokemonItemResponse.fromJson(String data) {
    return PokemonItemResponse.fromMap(
        json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [PokemonItemResponse] to a JSON string.
